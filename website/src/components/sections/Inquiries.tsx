    ...
    return (
        <section className="max-w-[1400px] mx-auto px-6 pb-24">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                {/* Main Content */}
                <div className="lg:col-span-6 bg-[#5c463a] rounded-xl p-10 flex flex-col justify-between">
                    <div>
                    ...
                    <div className="flex gap-4">
                        <button className="bg-white text-black px-5 py-3 rounded text-sm font-semibold flex items-center gap-2 hover:bg-gray-100 transition">
                            <Mail className="w-4 h-4" />
                            Send Us an Email
                        </button>
                        <button className="bg-transparent border border-white/20 text-white px-5 py-3 rounded text-sm font-medium flex items-center gap-2 hover:bg-white/10 transition">
                ...
                {/* Right List */}
                <div className="lg:col-span-3 bg-[#111] rounded-xl p-8 border border-white/5">
