        ...
        <section className="max-w-[1400px] mx-auto px-6 py-24">
            <div className="mb-16">
                <h2 className="text-4xl md:text-5xl font-semibold text-white tracking-tight mb-4">
                    Tiyuni Peaks <span className="text-red-400">Lifestyle</span> and <br />Amenities
                </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="grid grid-rows-2 gap-6">
                    {/* Card 1 */}
                    <div className="bg-[#0f0f0f] border border-white/5 rounded-2xl p-10 flex flex-col justify-between hover:border-white/10 transition group">
                        <div>
                            ...
                            <h3 className="text-3xl font-semibold text-orange-400 mb-4 tracking-tight">Shops and Restaurants for the Family</h3>
                    ...
                    <div className="bg-[#0f0f0f] border border-white/5 rounded-2xl p-10 flex flex-col justify-between hover:border-white/10 transition group">
                        <div>
                            ...
                            <h3 className="text-3xl font-semibold text-orange-400 mb-4 tracking-tight">Ease and Secure Estate Access</h3>
                            <p className="text-lg text-gray-400 leading-relaxed">
                ...
                {/* Large Image Card */}
                <div className="relative rounded-2xl overflow-hidden min-h-[500px] lg:min-h-auto group">
                    <img
                    ...
                    <div className="relative h-full flex flex-col justify-end p-10">
                        ...
                        <h3 className="text-3xl font-semibold text-orange-400 mb-4 tracking-tight">Club House and <br />Community Activities</h3>
